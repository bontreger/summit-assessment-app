...
const LOGO_URL = 'https://bontreger.github.io/summit-assessment-app/Logo-Red_Hat-Consulting-A-Standard-RGB.svg';
const LOGO_REVERSE_URL = 'https://bontreger.github.io/summit-assessment-app/Logo-Red_Hat-Consulting-A-Reverse-RGB.svg';
      ...
      <table width="680" cellpadding="0" cellspacing="0" role="presentation" style="background:${RH.white};max-width:680px;width:100%;border-radius:3px;overflow:hidden;box-shadow:0 2px 4px rgba(21,21,21,0.12)">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td style="vertical-align:middle;width:220px">
                <img src="${LOGO_URL}" alt="Red Hat Consulting" style="height:36px;width:auto;display:block">
              </td>
        ...
        <tr><td style="padding:32px;font-family:${FONT_TEXT};font-size:14px;line-height:1.6;color:${RH.gray95}">
          ...
          <p style="margin:0 0 28px;font-size:15px;color:${RH.gray60};line-height:1.7">
            ...
            our Red Hat Consulting team would love to help.<br><br>
            <a href="https://www.redhat.com/en/services/consulting?sc_cid=7015Y0000048B0nQAE#contact" style="color:${RH.blue};text-decoration:none;font-weight:700">Contact Red Hat Consulting &rarr;</a>
          </p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              ...
              <td style="text-align:right;vertical-align:middle;font-family:${FONT_TEXT};font-size:12px;color:${RH.gray30};line-height:1.5">
                ...
                <a href="https://www.redhat.com/en/services/consulting?sc_cid=7015Y0000048B0nQAE#contact" style="color:${RH.blueLight};text-decoration:none">Schedule a deeper assessment &rarr;</a>
              </td>
            </tr>
          </table>
        </td></tr>
